...
let foodBowl2=false;
let bowlFull=false;//All global variables needed


function livingRoom() {//function for living room
    clear();//clean previous text
    ...
    print("\nWhere do you want to go next? Say one of these choices:" +
        "\n\tEntry Way\n\tDining Room");//printing needed text
    
    function processInput(input){//allows browser to process imput
...
function diningRoom() {//open dining room funtions
    clear();//clear previous text
    print("\nYou are in the dining room");
    print("\nWhere do you want to go next? Say one of these choices:" +
        "\n\tLiving Room\n\tKitchen");//print needed text
    
    function processInput(input){//allow browser to process input
...
function kitchen() {//open kitchen funtion
    clear();//clear previous text
    print("\nYou are in the kitchen!");
    print("\nYou see a large container full of dog food.")
    print("\nWhere do you want to go next? Say one of these choices:" +
        "\n\tDining Room");//print needed text
...
function office() {//open office function
    clear();//clear previous text
    print("\nYou are in the office!");
    print("\nWhere do you want to go next? Say one of these choices:" +
        "\n\tEntry Way");//print needed text
...
function start(){//open starting screen
